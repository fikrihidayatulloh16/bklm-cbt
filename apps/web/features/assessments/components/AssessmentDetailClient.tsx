// apps/web/features/assessments/components/AssessmentDetailClient.tsx
'use client';
...
// Components
import PublishModal from "./publishModal"; // Sesuaikan path jika perlu
import AssessmentHeader from "./AssessmentIdHeader";
import AssessmentDetailTabs from "./assessmentDetailTabs";
import AssessmentCardContent from "./assessmentCardContent";
...
interface Props {
  assessmentId: string;
  schoolId: string; // 👈 Diterima dari "Bapak"
}

export default function AssessmentDetailClient({ assessmentId, schoolId }: Props) {
  // Hook client aman dieksekusi di sini
  const {
    assessment,
    distinctClasses,
    submissions,
    ...
    isError,
    error,
  } = useAssessmentDetailLogic(); // (Catatan: Jika hook ini butuh ID, pastikan Anda mengopernya: useAssessmentDetailLogic(assessmentId))
  ...
  return (
    <div className="space-y-6">
      ...
      <PublishModal 
        ...
        schoolId={schoolId} // 👈 SEKARANG AMAN! schoolId pasti berisi string.
      />

...
[ ] Buat metode setAnswer (Untuk menyimpan jawaban satuan secara real-time ke Redis).

[ ] Buat metode harvestAnswers (Untuk menarik seluruh data jawaban dan langsung menghapusnya dari Redis, gunakan perintah HGETALL dipadukan dengan penghapusan kunci atau pipeline agar atomik).
...
[ ] Modifikasi endpoint POST /questions/answer di Controller utama.

[ ] Ubah pemanggilan dari PostgresRepository.save menjadi RedisService.setAnswer.

[ ] Pengontrol harus merespons 200 OK (atau 201 Created) segera setelah data berhasil ditulis di Redis.
